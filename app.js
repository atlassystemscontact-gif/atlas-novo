(() => {
  ...
  const translations = {
    pt: {
      ...
      "meta.title": "Atlas Systems — Sistemas que movem negócios",
      "meta.description": "A Atlas Systems cria automações com inteligência artificial, sistemas personalizados, landing pages e bots inteligentes para empresas que querem crescer.",
      "meta.ogDescription": "Automação inteligente e soluções digitais orientadas a eficiência, escala e resultados.",
      ...
      "ribbon.text": "Automatizamos o futuro",
      ...
      "hero.eyebrow": "Automação inteligente · Sistemas personalizados",
      "hero.titleLine1": "Sistemas que",
      "hero.titleLine2": "movem negócios.",
      "hero.description": "Criamos automações com inteligência artificial, sistemas personalizados, landing pages e bots inteligentes para transformar operações em negócios mais eficientes, escaláveis e lucrativos.",
      ...
      "services.eyebrow": "O que podemos oferecer",
      "services.title": "Serviços",
      "services.description": "Do diagnóstico à implementação, combinamos estratégia, design e engenharia para resolver gargalos reais e gerar resultados mensuráveis.",
      "services.idealFor": "Ideal para",
      "services.included": "Principais entregáveis",
      "services.investment": "Próximo passo",
      "services.cta": "Falar com especialista",
    ...
    en: {
      ...
      "meta.title": "Atlas Systems — Systems that move businesses",
      "meta.description": "Atlas Systems creates AI automation, custom systems, landing pages, and intelligent bots for companies that want to grow.",
      "meta.ogDescription": "Intelligent automation and digital solutions designed for efficiency, scale, and results.",
      ...
      "ribbon.text": "We automate the future",
      ...
      "hero.eyebrow": "Intelligent automation · Custom systems",
      "hero.titleLine1": "Systems that",
      "hero.titleLine2": "move businesses.",
      "hero.description": "We create AI automation, custom systems, landing pages, and intelligent bots to turn operations into more efficient, scalable, and profitable businesses.",
      ...
      "services.eyebrow": "What we can offer",
      "services.title": "Services",
      "services.description": "From assessment to implementation, we combine strategy, design, and engineering to solve real bottlenecks and create measurable results.",
      "services.idealFor": "Ideal for",
      "services.included": "Key deliverables",
      "services.investment": "Next step",
      "services.cta": "Talk to a specialist",
